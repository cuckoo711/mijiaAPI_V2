...
def example_credential_path_config():
    ...
    # 演示不同的路径配置方式
    print("支持的路径格式：")
    print("  1. 相对路径: configs/credential.json")
    print("     -> 相对于项目根目录")
    print("  2. 用户目录: ~/configs/credential.json")
    print("     -> 展开为用户主目录")
    ...
    print("配置文件示例：")
    print("  [security]")
    print("  credential_path = 'configs/credential.json'  # 项目级")
    print("  # 或")
    print("  credential_path = '~/configs/credential.json'  # 全局级")
    print()
...
def example_environment_variables():
    ...
    print("  export MIJIA_CREDENTIAL_PATH=~/configs/credential.json")
    print()
...
def example_credential_migration():
    ...
    print("    default_path=Path('~/configs/credential.json')")
    print(")")
...
def example_multi_environment():
    ...
    print("  [security]")
    print("  credential_path = 'configs/dev_credential.json'")
    print()
